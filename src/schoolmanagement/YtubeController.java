 ...
 * @author Walton
 */
public class YtubeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        String urlweb = "https://www.youtube.com/channel/UCkw0odWQDBeet091ZBtYQOg";
        web.load(urlweb);
        // TODO
    }    
    ...
    private void back(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new
          ...
          stage.setScene(new YtubeController.scene(root2));
