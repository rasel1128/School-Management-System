 ...
 * @author Walton
 */
public class CulturalClubController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        String urlweb = "https://www.facebook.com/groups/1724250097885217/";
        web.load(urlweb);
        // TODO
    }    
    ...
    private void back(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new
          ...
          stage.setScene(new CulturalClubController.scene(root2));
